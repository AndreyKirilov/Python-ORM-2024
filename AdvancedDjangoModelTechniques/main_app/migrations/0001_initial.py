    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[main_app.models.customer_name])),
                ...
                ('phone_number', models.CharField(max_length=13, validators=[main_app.models.customer_phone_number])),
